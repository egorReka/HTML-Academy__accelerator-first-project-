  ...
  'centre': [
    {
      ...
      'answer': 'При первом посещении и покупке абонемента, необходимо заполнить анкету и подписать договор. При покупке абонемента онлайн, анкета также заполняется онлайн и договор придет вам на почту.',
    },
    {
    ...
    },
    {
      ...
      'answer': 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Natus earum voluptatem temporibus harum delectus praesentium maiores nostrum quia nesciunt, explicabo sint quisquam veritatis commodi nemo, quaerat ducimus. In, facere numquam!',
    },
    {
      'question': 'Сколько тренеров работает в клубе и какова их квалификация?',
      'answer': 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam dolore tempora soluta rerum illo quos, iusto architecto excepturi odio, suscipit natus. Fugiat autem non inventore neque, tempora itaque cumque in? Repudiandae sit labore expedita facere maiores adipisci asperiores optio perspiciatis deserunt, odit magnam ducimus id aut. Eius, odio! Praesentium accusantium perspiciatis sit dolore, in quasi voluptas doloremque error enim quos?',
    },
  ],
  'subscription': [
    {
...
export { ASKED_QUESTIONS, PRICE_OPTIONS };
